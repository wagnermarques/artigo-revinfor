...
relações sociais em geral. Esse pano de fundo da Rússia pré e
pós-Revolução de Outubro, e as tarefas da educação no contexto de
construção do socialismo, são discutidos por \citeonline{prestes2024para}.
...
Então o processo mediado de socialização é o que humaniza e potencializa
o aprendizado. O desenvolvimento humano é o conceito fundamental. Os
aspectos culturais para \Vig{} também assume grande importancia para
alcance dos objetivos educacionais.

Dentro desse contexto é que se coloca a defectologia. O
desenvolvimento humano é promovido pelo processo de
compensação. Compensação significa que as oportunidades sociais
...
concepção de educação social em Vigotski, voltada à escolarização de
crianças com deficiência, é aprofundada por \citeonline{dainez2018concepcao}.

Portanto, o foco não é na deficiência, mas continua sendo o
aluno. Inclusive, é de responsabilidade comum e não somente do
professor, idealmente, os esforços para oportunizar as rotas sociais
alternativas para promoção do aprendizado nessses casos.

No curso foi citado várias vezes o conceito de \Obtiene. Os discentes
citaram muitas vezes alguma dificuldade em significar tal conceito,
mas como aluno me pareceu sinomimo de aprendizado. Essa própria
dificuldade de tradução do termo \Obtiene{} e de outros conceitos da
...
Como dito anteriormente, diante da deficiência, o olhar e, o foco,
continua sendo nas potencialidades do aluno. Para \Vig{} o
desenvolvimento humano se dá igualmente para o aluno com deficiência e
o aluno sem deficiência.

Essa é a base do conceito histórico-cultural no caso da
defectologia. A abordagem social, portanto, não muda, a não ser pela
necessidae de rotas alternativas pra interações sociais mediadas.

No curso e nos artigos que lemos, foi bastante apresentada as objeções
de \Vig{} ao que pensava Adler. Sinteticamente, Adler olhava para a
questão de maneira mais individual problematizando o assunto a partir
dessa perspectiva. Já \Vig{} contestava propondo um olhar mais
coletivo de abordagem da questão encontrando obviamente consequencias
diferenciasdas de Adler. Esse diálogo de \Vig{} com Adler em torno do
conceito de compensação é reconstituído por \citeonline{dainez2014conceito}
...
deficiência permite ou não o indivíduo fazer. Quais suas possiblidades
e limitações a partir da deficiência. A abordagem histórico cultural
culmina exatamente no romper com essa abordagem determinística de modo
que as potencialidades da pessoa com deficiência. O contraste
histórico entre Itard e \Vig{} nesse rompimento com o determinismo
biológico é discutido por \citeonline{tunes2020jean}.

Isso lembra inclusive o conceito de supercompensação o que considera o
fato de que uma deficiência potencializa várias outras habilidades e
competências da pessoa que podem ser catalizadoras de seu
...
Sendo assim ví a lista dos conceitos, fui relecionando e produzindo
...
como essa mentalidade impunsionou \Vig{}
...
Como resultado final, acredido que o curso contribuiu também o
...
Apesar de formato de artigo, este texto foi escrito em primeira
pessoa e sem releitura do que eu já tinha lido. Se por um lado é uma
limitação por ser um artigo, por outro, expressa exatamente o que
apreendi e estive apto a refletir independentemente. Provavelmente,
este era a real intensão dos avaliadores para este trabalho final.
