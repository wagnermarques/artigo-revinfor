...
\section{Introdução}
Esse texto é um rascunho de ideias, apenas.
...
\section {Os Momentos Históricos Relevantes}
Estes conceitos foram fortemente impactados por em alguns dos momentos históricos, quais sejam:

\begin{enumerate}
\item Advento da Imprensa
...
Estamos vivendo um momento histórico tão relevante quanto ao da Revolução Industrial de refletir sobre os impactos tremendos dessa transformação histórica não é só uma justificativa mas uma responsabilidade histórica também.
