% FROM: modelo-revista-infor from abtex2-modelo-artigo.tex, v-1.9.2 laurocesar
% Copyright 2012-2014 by abnTeX2 group at http://abntex2.googlecode.com/ (Any other group?)
%

% ------------------------------------------------------------------------
% abnTeX2: Modelo de Artigo Acadêmico em conformidade com
% ABNT NBR 6022:2003: Informação e documentação - Artigo em publicação 
% revista infor: https://ojs.ead.unesp.br/index.php/cdep3/index
% ------------------------------------------------------------------------

\author{Fn. SecondName}
...
\autor{Equipe \abnTeX\thanks{\url{http://abntex2.googlecode.com/}} \and Nome do Autor\thanks{laurocesar@laurocesar.com}}
%\local{Brasil}
%\data{2014, v-1.9.2}
% ---
